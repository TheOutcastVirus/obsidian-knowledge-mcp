...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: [
        {
            name: 'list_notes',
            description: 'List all notes in the vault with optional filtering by folder, tags, or date range. ' +
        ...
        {
            name: 'read_note',
            description: 'Read a note with full metadata including parsed frontmatter, outgoing wikilinks, ' +
        ...
        },
        {
            ...
            description: 'Read multiple notes in a single call to reduce round trips. ' +
        ...
        {
            name: 'search_notes',
            description: 'Full-text search across vault using literal string or regex pattern. ' +
        ...
        },
        {
            ...
            description: 'Get the complete folder hierarchy of the vault with note counts. ' +
        ...
        {
            name: 'update_note',
            description: 'Update an existing note with new content. Completely replaces the note content. ' +
        ...
        {
            name: 'move_note',
            description: 'Move a note to a new location and optionally update all backlinks. ' +
        ...
        {
            name: 'delete_note',
            description: 'Delete a note and optionally clean up all references to it in other notes. ' +
        ...
        },
        {
            ...
            description: 'Extract and parse YAML frontmatter from a single note. ' +
        ...
        },
        {
            ...
            description: 'Update frontmatter fields in a single note without touching content. ' +
        ...
        },
        {
            ...
            description: 'Update frontmatter across multiple notes in a single operation. ' +
        ...
        },
        {
            ...
            description: 'Validate frontmatter against a schema across one or more notes. ' +
    ...
    try {
        ...
        switch (name) {
            ...
            case 'read_note': {
                ...
                const result = await navigation.readNote(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'read_notes_batch': {
                ...
                const result = await navigation.readNotesBatch(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'search_notes': {
                ...
                const result = await navigation.searchNotes(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'create_note': {
                ...
                const result = await notes.createNote(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'update_note': {
                ...
                const result = await notes.updateNote(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'move_note': {
                ...
                const result = await notes.moveNote(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'delete_note': {
                ...
                const result = await notes.deleteNote(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'get_frontmatter': {
                ...
                const result = await frontmatter.getFrontmatter(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'update_frontmatter': {
                ...
                const result = await frontmatter.updateFrontmatter(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'bulk_update_frontmatter': {
                ...
                const result = await frontmatter.bulkUpdateFrontmatter(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'audit_frontmatter': {
                ...
                const result = await frontmatter.auditFrontmatter(vault, args);
                return {
                    content: [
                        {
                            type: 'text',
